...
export const AIWarningMounter = createComponentMounter<AIWarningConfig>(
  AIWarning,
  "adp-ai-warning",
);
export const ApplicationListMounter =
  createComponentMounter<ApplicationListConfig>(
    ApplicationList,
    "adp-application-list",
  );
export const CreateConversationMounter =
  createComponentMounter<CreateConversationConfig>(
    CreateConversation,
    "adp-create-conversation",
  );
export const CustomizedIconMounter =
  createComponentMounter<CustomizedIconConfig>(
    CustomizedIcon,
    "adp-customized-icon",
  );
export const HistoryListMounter = createComponentMounter<HistoryListConfig>(
  HistoryList,
  "adp-history-list",
);
export const LogoAreaMounter = createComponentMounter<LogoAreaConfig>(
  LogoArea,
  "adp-logo-area",
);
export const PersonalAccountMounter =
  createComponentMounter<PersonalAccountConfig>(
    PersonalAccount,
    "adp-personal-account",
  );
export const SearchMounter = createComponentMounter<SearchConfig>(
  Search,
  "adp-search",
);
export const SettingsMounter = createComponentMounter<SettingsConfig>(
  Settings,
  "adp-settings",
);
export const SidebarToggleMounter = createComponentMounter<SidebarToggleConfig>(
  SidebarToggle,
  "adp-sidebar-toggle",
);
export const ChatMounter = createComponentMounter<ChatComponentConfig>(
  Chat,
  "adp-chat",
);
export const ChatItemMounter = createComponentMounter<ChatItemConfig>(
  ChatItem,
  "adp-chat-item",
);
export const ChatSenderMounter = createComponentMounter<ChatSenderConfig>(
  ChatSender,
  "adp-chat-sender",
);
export const ChatAppTypeMounter = createComponentMounter<ChatAppTypeConfig>(
  ChatAppType,
  "adp-chat-app-type",
);
export const OptionCardMounter = createComponentMounter<OptionCardConfig>(
  OptionCard,
  "adp-option-card",
);
export const RecordIconMounter = createComponentMounter<RecordIconConfig>(
  RecordIcon,
  "adp-record-icon",
);
export const ADPChatMounter = createComponentMounter<ADPChatConfig>(
  ADPChat,
  "adp-chat-layout",
);
export const MainLayoutMounter = createComponentMounter<MainLayoutConfig>(
  MainLayout,
  "adp-main-layout",
);
export const SideLayoutMounter = createComponentMounter<SideLayoutConfig>(
  SideLayout,
  "adp-side-layout",
);
export const ShareChatMounter = createComponentMounter<ShareChatConfig>(
  ShareChat,
  "adp-share-chat",
);
